...
const PLAYER_FORFEIT_GAME = 'PLAYER_FORFEIT_GAME';
...
module.exports = {
    ...
    GET_OPPONENT_BOARD, ON_NEXT_MOVE, GET_GAME_HOST, PLAYER_LEAVE_GAME, GAME_MESSAGE_SEND,
    GET_HIGH_SCORES, PLAYER_FORFEIT_GAME
